...
public class PicasaSource extends CursorPhotoSource {
    ...
    protected Collection<ImageData> findImages(int howMany) {
        ...
        if (cursor != null) {
            ...
            log(TAG, "received a null cursor in findImages()");
        }
    ...
    private String resolveAccount(String id) {
        ...
        if (cursor != null) {
            ...
            log(TAG, "received a null cursor in resolveAccount()");
        }
        return displayName;
    }
    ...
    private Collection<String> resolveAlbumIds(String id) {
        ...
        if (cursor != null) {
            ...
            log(TAG, "received a null cursor in resolveAlbumIds()");
        }
        return albumIds;
    }
    ...
    public Collection<AlbumData> findAlbums() {
        ...
        if (cursor != null) {
            ...
            Log.e(TAG, "received a null cursor in findAlbums()");
        }
